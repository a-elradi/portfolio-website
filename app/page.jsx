    ...
    <div className="min-h-screen bg-[#030014] text-white font-sans selection:bg-purple-500/30 overflow-x-hidden">
      ...
      <main id="home" className="relative z-10 max-w-6xl mx-auto px-6 pt-32 pb-20">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-5 mb-24">
          ...
          {/* NAME CARD */}
          <div className="md:col-span-4 md:row-span-1 min-h-[250px] bg-[#04050b] border border-cyan-400/10 rounded-[2rem] p-8 flex flex-col justify-between shadow-[0_0_45px_rgba(56,_189,_248,_0.18)]">
            <div>
          ...
          {/* MAIN PHOTO */}
          <div className="md:col-span-4 md:row-span-2 h-[610px] bg-[#0a0a0f] border border-white/5 rounded-[2.5rem] overflow-hidden shadow-[0_0_55px_rgba(59,_130,_246,_0.12)] relative">
            <img
          ...
          {/* CRAFT */}
          <div className="md:col-span-4 md:row-span-1 min-h-[610px] bg-[#04050b] border border-white/10 rounded-[2.5rem] p-10 flex flex-col justify-between shadow-[0_0_30px_rgba(59,_130,_246,_0.12)]">
            <div>
          ...
          {/* MINDSET */}
          <div className="md:col-span-4 md:row-start-2 h-[280px] bg-[#04050b] border border-white/10 rounded-[2.5rem] p-10 flex flex-col justify-between gap-6 shadow-[0_0_35px_rgba(255,_255,_255,_0.06)]">
            <div>
          ...
          {/* QUOTE */}
          <div className="md:col-span-4 md:row-start-1 min-h-[210px] bg-[#04050b] border border-white/10 rounded-[2.5rem] p-10 flex flex-col justify-center shadow-[0_0_35px_rgba(255,_255,_255,_0.06)]">
          ...
          {/* LOCATION */}
          <div className="md:col-span-4 md:row-start-1 min-h-[210px] bg-[#04050b] border border-white/10 rounded-[2.5rem] p-8 flex flex-col justify-between relative overflow-hidden shadow-[0_0_35px_rgba(255,_255,_255,_0.05)]">
